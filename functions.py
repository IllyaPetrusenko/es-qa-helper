...
# Create EI
def create_ei(host, token, x_operation_id, payload, idno):
    # payload['buyer']['identifier']['id'] = idno
    requests.post(url=f'{host}/do/ei?country=MD&lang=EN&testMode=true', headers={
        'Authorization': f'Bearer {token}',
